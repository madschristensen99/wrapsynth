...
\begin{frame}[t]{\color{textprimary}\textbf{Fun Gerbil: Cypherpunk Founders}}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}
      ...
      \draw[textsecondary,line width=1.5pt,rounded corners=4pt] (mads.south west) rectangle (mads.north east);
    \end{scope}
    ...
    \begin{scope}
      ...
      \draw[textsecondary,line width=1.5pt,rounded corners=4pt] (kyle.south west) rectangle (kyle.north east);
    \end{scope}
    ...
    \begin{scope}
      ...
      \draw[textsecondary,line width=1.5pt,rounded corners=4pt] (tiago.south west) rectangle (tiago.north east);
    \end{scope}
