...
import { showLPVerificationStatus, updateMintProgress, showSuccess, showConfirmModal, showSuccessNotification, showMintComplete } from './ui.js?v=3.3';
...
export class MintFlow {
    ...
    async setupClaimButton() {
        const { showClaimWsXmrButton } = await import('./ui.js?v=3.3');
