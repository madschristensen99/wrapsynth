...
% -------------------------------------------------
\begin{frame}{\color{textprimary}\textbf{Fun Gerbil: Three Product Lines}}
  \begin{tikzpicture}[remember picture,overlay]
...
% -------------------------------------------------
\begin{frame}[t]{\color{textprimary}\textbf{Fun Gerbil: Revenue Streams At Multiple Levels}}
  \begin{tikzpicture}[remember picture,overlay]
    \fill[primary,opacity=0.05] (current page.south west) rectangle (current page.north east);
  \end{tikzpicture}
...
% -------------------------------------------------
\begin{frame}[t]{\color{textprimary}\textbf{Fun Gerbil: Privacy Market is Huge}}
  \begin{tikzpicture}[remember picture,overlay]
    \fill[primary,opacity=0.05] (current page.south west) rectangle (current page.north east);
  \end{tikzpicture}
...
% -------------------------------------------------
\begin{frame}[t]{\color{textprimary}\textbf{Fun Gerbil: Launching and Future Features}}
  \begin{tikzpicture}[remember picture,overlay]
    \fill[primary,opacity=0.05] (current page.south west) rectangle (current page.north east);
  \end{tikzpicture}
...
% -------------------------------------------------
\begin{frame}[t]{\color{textprimary}\textbf{Fun Gerbil: Founding Cypherpunks}}
  \begin{tikzpicture}[remember picture,overlay]
    \fill[primary,opacity=0.05] (current page.south west) rectangle (current page.north east);
  \end{tikzpicture}
